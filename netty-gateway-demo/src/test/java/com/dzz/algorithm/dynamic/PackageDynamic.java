 ...
 * 要求出f(15)，只需要知道f(14),f(13)的值，而f(14),f(13)是如何算出来的，对之后的问题没有影响。
 * “未来与过去无关”，这就是无后效性。
 * （严格定义：如果给定某一阶段的状态，则在这一阶段以后过程的发展不受这阶段以前各段状态的影响。）
 * <p>
 * 【最优子结构】
 * 比如凑钞票问题，我们记“凑出n所需的最少钞票数量”为f(n).
 ...
 * 我们的目标是求出f(T).找出f(x)与哪些局面有关（记为p），
 * 写出一个式子（称为状态转移方程），通过f(p)来推出f(x).
 * 【DP三连】　　
 * 设计DP算法，往往可以遵循DP三连：　　
 * 我是谁？  ——设计状态，表示局面　　
 * 我从哪里来？　　我要到哪里去？  ——设计转移　　
 * 设计状态是DP的基础。
 * 接下来的设计转移，有两种方式：一种是考虑我从哪里来（本文之前提到的两个例子，都是在考虑“我从哪里来”）；
 * 另一种是考虑我到哪里去，这常见于求出f(x)之后，更新能从x走到的一些解。这种DP也是不少的，我们以后会遇到。　　
 * 总而言之，“我从哪里来”和“我要到哪里去”只需要考虑清楚其中一个，就能设计出状态转移方程，
 * 从而写代码求解问题。前者又称pull型的转移，后者又称push型的转移。
 *
 */
